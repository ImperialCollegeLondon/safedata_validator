...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            ((3, f"project_database = {FIXTURE_FILES.mf}"),),
            OSError,
            (
                (INFO, "Configuring Resources"),
                (INFO, "Configuring resources from init"),
        ...
        pytest.param(
            ...
            ((3, f"project_database = {FIXTURE_FILES.rf.gbif_file}"),),
            ValueError,
            (
                (INFO, "Configuring Resources"),
                (INFO, "Configuring resources from init"),
        ...
        pytest.param(
            ...
            ((3, f"project_database = {FIXTURE_FILES.rf.gaz_file}"),),
            ValueError,
            (
                (INFO, "Configuring Resources"),
                (INFO, "Configuring resources from init"),
        ...
        pytest.param(
            ...
            ((3, f"project_database = {FIXTURE_FILES.rf.empty_localias_file}"),),
            ValueError,
            (
                (INFO, "Configuring Resources"),
                (INFO, "Configuring resources from init"),
        ...
        pytest.param(
            ...
            ((3, f"project_database = {FIXTURE_FILES.rf.project_database_file_bad}"),),
            ValueError,
            (
                (INFO, "Configuring Resources"),
                (INFO, "Configuring resources from init"),
